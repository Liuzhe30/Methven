...
atac_path = '../../datasets/atac_cut_Mono/'
atac_ori_path = '../../datasets/atac_mapping_post_Mono/'
dnabert_path = '../../datasets/dnabert_embedding_Mono/'
merge_path = '../../datasets/merge_dnabert_Mono/'
output_path1 = '../../datasets/final_Mono/'
