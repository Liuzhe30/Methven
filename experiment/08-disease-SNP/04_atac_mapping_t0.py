...
atac_path = 'hg19_ATAC/hg19_t0_atac.bw'
...
file_path = 'data/atac_mapping_t0/'
output_path = 'data/atac_mapping_post_t0/'
...
# average pooling
file_path = 'data/atac_mapping_post_t0/'
output_path = 'data/atac_cut_t0/'
