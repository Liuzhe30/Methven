...
file_path = '../../datasets/atac_mapping_retina/'
output_path = '../../datasets/atac_mapping_post_retina/'
...
# average pooling
file_path = '../../datasets/atac_mapping_post_retina/'
output_path = '../../datasets/atac_cut_retina/'
