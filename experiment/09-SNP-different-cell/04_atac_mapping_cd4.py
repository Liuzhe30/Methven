...
atac_path = '../../datasets/raw/CD4T.bigWig'
output_path = 'data/atac_mapping_cd4/'
...
file_path = 'data/atac_mapping_cd4/'
output_path = 'data/atac_mapping_post_cd4/'
...
# average pooling
file_path = 'data/atac_mapping_post_cd4/'
output_path = 'data/atac_cut_cd4/'
