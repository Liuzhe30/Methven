...
output_path = 'data/atac_mapping_mono/'
...
file_path = 'data/atac_mapping_mono/'
output_path = 'data/atac_mapping_post_mono/'
...
# average pooling
file_path = 'data/atac_mapping_post_mono/'
output_path = 'data/atac_cut_mono/'
