...
atac_path = '../../datasets/atac_cut_retina/'
atac_ori_path = '../../datasets/atac_mapping_post_retina/'
dnabert_path = '../../datasets/dnabert_embedding_retina/'
merge_path = '../../datasets/merge_dnabert_retina/'
output_path1 = '../../datasets/final_retina/'
